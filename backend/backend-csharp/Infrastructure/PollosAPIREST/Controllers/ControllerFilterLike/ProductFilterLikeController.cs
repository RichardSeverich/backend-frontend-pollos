...
namespace PollosAPIREST.Controllers.ControllerFilterLike
{
    [Authorize]
    [ApiController]
    [Route("/product/filter-like")]
    public class ProductFilterLikeController
    {
        private readonly UseCaseFilterLikeProduct _useCaseFilterLike;

        public ProductFilterLikeController(UseCaseFilterLikeProduct useCase)
        {
