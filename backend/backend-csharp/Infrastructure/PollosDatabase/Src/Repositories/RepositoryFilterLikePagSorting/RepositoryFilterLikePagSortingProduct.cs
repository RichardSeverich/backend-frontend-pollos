...
{
    public class RepositoryFilterLikePagSortingProduct : IRepositoryFilterLikePagSortingProduct
    {
        public List<DomainEntityProduct> FilterSorting(string pageNumber, string totalPageNumber, List<string> columnsAndValues, List<string> sortingList)
        {
            var dbList = DaoFilterPagSortingGeneric.Filter<DbEntityProduct>(pageNumber, totalPageNumber,
